        ...
        <div id="dataPop1" class="data_pop data_pop1">
            <div class="data_pop_hd">
                <div class="data_action">
                    <button id="dataTag1" class="ox_add_link data_btn" data-i18n="chart2.btnSetVersion">设置版本点</button>
                ...
                <div class="data_filter1">
                    <div class="data_time clearfix">
                        ...
                        <div class="data_fr data_datepreset">
                            <ul class="clearfix">
                                <li class="data_datepreset_item data_datepreset_item1 data_hidden" id="dataRecentDays1" data-v="1"><a href="javascript:;">最近7天</a></li>
                                <li class="data_datepreset_item data_hidden" id="dataRecentDays2" data-v="2"><a href="javascript:;">最近15天</a></li>
                                <li class="data_datepreset_item data_hidden" id="dataRecentDays3" data-v="3"><a href="javascript:;">最近30天</a></li>
                                <li>
