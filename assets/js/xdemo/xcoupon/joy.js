...
JJ('joy',function(M,V,C){
    ...
    V.cartTemplate = JJ.heredoc(function(){/*
    ...
    */});
    ...
    V.viewTemplate = JJ.heredoc(function(){/*
    ...
    */});
    ...
    V.favTemplate = JJ.heredoc(function(){/*
    ...
    */});
    ...
    V.orderTemplate = JJ.heredoc(function(){/*
    ...
    */});
            ...
            case "cart":
                $.ajax({
                     ...
                     success:function(result){
                        ...
                        // console.log();
                        $("#xpanel_cart .xpanel_inner").html(JJ.toHtml(V.cartTemplate,_goodsInfo));
                     }
                });
                break;
            case "view":
                $.ajax({
                     ...
                     success:function(result){
                        ...
                        // console.log();
                        $("#xpanel_view .xpanel_inner").html(JJ.toHtml(V.viewTemplate,_goodsInfo));
                     }
                });
                break;
            case "fav":
                ...
                $.ajax({
                     ...
                     success:function(result){
                        ...
                        // console.log();
                        $("#xpanel_fav .xpanel_inner").html(JJ.toHtml(V.favTemplate,_goodsInfo));
                     }
                });
                break;
            case "order":
                ...
                $.ajax({
                     ...
                     success:function(result){
                        ...
                        console.log();
                        $("#xpanel_order .xpanel_inner").html(JJ.toHtml(V.orderTemplate,_goodsInfo));
                     }
                });
                break;
            case "coupon":
    ...
    C._init = function(){
        ...
        JJ.$win.bind('onShowXPanel',function(e,panelId){
            // alert('面板显示:'+panelId);
            //接下来写面板显示后的各种应用逻辑
